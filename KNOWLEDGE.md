...
| **Local filesystem** | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `ONBOARDING.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`, `.agor/priority-context.json` | Core teammate brainstem/system context |
